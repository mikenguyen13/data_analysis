...
E[Y_i | D_i = 1] - E[Y_i | D_i = 0] &= (E[Y_{1i}-Y_{0i}|D_1 = 1] ) + (E[Y_{0i} |D_i = 1] - E[Y_{0i} |D_i = 0]) \\
...
Hence, the conditional expectation of an idnivudal outcome on treatment status is
