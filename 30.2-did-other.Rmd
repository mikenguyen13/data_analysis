...
IFEct can outperform MC when the latent factors (of unobservables) is indeed low-rank/sparse and strong; MC prevails when unobservables are *dense and weak.*
