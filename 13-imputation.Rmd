...
The `md.pairs()` summary below tabulates the four observed/missing combinations for every pair of variables in the modified Anscombe dataset.
...
The skeleton below sketches three additional `naniar` displays (faceted scatter, missingness-by-variable, missingness-by-factor) that practitioners typically add when grouping structure is present.
