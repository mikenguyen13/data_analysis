...
Figure \@ref(fig:hpc-parallel-benchmark) compares runtime and memory across the parallel back-ends (`parLapply`, `foreach`/`doParallel`, and `future_lapply`) for small and large workloads at one, two, and four cores.

```{r hpc-parallel-benchmark, fig.cap="Runtime (top) and approximate memory use (bottom) by number of cores, parallel back-end, and dataset size for the HPC benchmarking demo.", message=FALSE, warning=FALSE}
###############################################################
