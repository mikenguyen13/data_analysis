...
2.  $$
    \tau^{\mathrm{dr,rc}}_{2} = \tau^{\mathrm{dr,rc}}_{1}+\left[\mathbb{E}(\mu_{1,1}(X) - \mu_{0,1}(X)|D=1) - \mathbb{E}(\mu_{1,1}(X) - \mu_{0,1}(X)|D=1,T=1)\right]\\
