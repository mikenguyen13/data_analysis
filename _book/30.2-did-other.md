...
#>       t+0       t+1       t+2       t+3       t+4 
#> 0.6104150 0.9879119 1.3888125 1.7574077 2.1240302
...
$$
\hat{\tau}^{\mathrm{reg}} = \Bigl(\overline{Y}_{1,1}\Bigr) - \Bigl(\overline{Y}_{1,0} + \frac{1}{n_{\mathrm{treat}}} \sum_{i:D_i=1} \bigl[ \hat{m}_{0,1}(X_i) - \hat{m}_{0,0}(X_i) \bigr] \Bigr),
$$
