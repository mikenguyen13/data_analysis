...
Researchers often prefer [TWFE](http://127.0.0.1:27683/#0) due to its ability to control for both unit- and time-specific unobserved confounders:
...
Examples of settings that can utilize this method:
...
<img src="30.2-did-other_files/figure-html/treatment-distribution-heatmap-1.png" alt="A heatmap showing treatment status over time for different countries. The x-axis represents years from 1960 to 2010, and the y-axis lists country codes. Blue indicates control periods, and red indicates treated periods." width="90%" />
<p class="caption">(\#fig:treatment-distribution-heatmap)Treatment Distribution Across Units and Time</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="30.2-did-other_files/figure-html/treatment-distribution-plot-1.png" alt="A heatmap visualizing treatment assignment across countries and years. Each row represents a country identified by a numeric code, and each column corresponds to a year from 1980 to 2019. Blue cells indicate treated periods, red marks the initial year of treatment, and pink or light gray cells represent untreated years. This visualization highlights variation in treatment timing and duration across units." width="90%" />
<p class="caption">(\#fig:treatment-distribution-plot)Treatment by Country and Year</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="30.2-did-other_files/figure-html/treatment-distribution-zoomed-1.png" alt="Zoomed-in heatmap of treatment distribution for a small subset of countries across years. Each row corresponds to a country code, and each column represents a year. The plot highlights a narrow band of treatment events in red, indicating the treatment start year, followed by blue for continued treatment, with surrounding periods shown in light gray or pink as untreated. This allows inspection of temporal alignment and treatment patterns across countries with synchronized or clustered interventions." width="90%" />
<p class="caption">(\#fig:treatment-distribution-zoomed)Focused Treatment Visualization</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="30.2-did-other_files/figure-html/treatment-effects-over-time-1.png" alt="A line plot showing estimated treatment effects over five time periods after treatment, labeled t+0 through t+4. Each point represents the estimated effect of treatment at a given time, with vertical lines indicating confidence intervals. The effects appear positive and relatively stable over time, with growing uncertainty further from the treatment period. The horizontal dashed line at zero marks the baseline for comparison, emphasizing the statistical range and potential significance of the estimates." width="90%" />
<p class="caption">(\#fig:treatment-effects-over-time)Post-treatment Effects Over Time</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="30.2-did-other_files/figure-html/fig-treatment-effect-time-1.png" alt="Error bar plot of treatment effects from t+0 to t+4 with increasing uncertainty." width="100%" />
<p class="caption">(\#fig:fig-treatment-effect-time)Estimated Effects of Treatment Over Time</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/did_balance_scatter.png" alt="Six panel plot comparing covariate balance using different matching methods and time lags" width="100%" />
<p class="caption">(\#fig:fig-matching-comparison)Variable Balance After Matched Set Refinement</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/p_covariate_balance.png" alt="Line plots showing covariate balance from time minus 4 to minus 1 for different methods and estimands" width="100%" />
<p class="caption">(\#fig:fig-balance-by-method)Covariate Balance Over Time by Refinement Method and Estimand</p>
</div>
...
: Main Families of Counterfactual Estimators
...
Setting $R=0$ recovers FEct. **Generalized Synthetic Control** (GSC) [@xu2017generalized] is an IFEct implementation with ridge penalization when $R>0$ (This estimator assumes treatments dont' revert).
...
-   [Two-stage DiD Estimator] [@gardner2022two; @borusyak2021revisiting]
...
<img src="30.2-did-other_files/figure-html/unnamed-chunk-22-1.png" width="90%" style="display: block; margin: auto;" />
...
<img src="30.2-did-other_files/figure-html/unnamed-chunk-22-2.png" width="90%" style="display: block; margin: auto;" />
...
<img src="30.2-did-other_files/figure-html/unnamed-chunk-23-1.png" width="90%" style="display: block; margin: auto;" />
...
<img src="30.2-did-other_files/figure-html/unnamed-chunk-28-1.png" width="90%" style="display: block; margin: auto;" />
...
2.  $$
    \tau^{\mathrm{dr,rc}}_{2} = \tau^{\mathrm{dr,rc}}_{1}+\left[\mathbb{E}(\mu_{1,1}(X) - \mu_{0,1}(X)|D=1) - \mathbb{E}(\mu_{1,1}(X) - \mu_{0,1}(X)|D=1,T=1)\right]\\-\left[\mathbb{E}(\mu_{1,0}(X) - \mu_{0,0}(X)|D=1) - \mathbb{E}(\mu_{1,0}(X) - \mu_{0,0}(X)|D=1,T=0)\right]
...
$$
\eta^{e,\mathrm{p}}(Y_1, Y_0, D, X) =\frac{D}{\mathbb{E}[D]}[m_{1,\Delta}(X) - m_{0,\Delta}(X) - \tau]\\+\frac{D}{\mathbb{E}[D]}[\Delta Y - m_{1,\Delta}(X)]\\-\frac{\pi(X)(1-D)}{(1 - \pi(X))\mathbb{E}[\tfrac{\pi(X)(1-D)}{1 - \pi(X)}]}[\Delta Y - m_{0,\Delta}(X)]
$$
...
$$
\eta^{e,\mathrm{rc}}(Y,D,T,X) =\frac{D}{\mathbb{E}[D]}[m_{1,\Delta}(X) - m_{0,\Delta}(X) - \tau]\\+\left[w_{1,1}^{\mathrm{rc}}(D,T)(Y - m_{1,1}(X)) - w_{1,0}^{\mathrm{rc}}(D,T)(Y - m_{1,0}(X))\right]\\-\left[w_{0,1}^{\mathrm{rc}}(D,T,X;p)(Y - m_{0,1}(X)) - w_{0,0}^{\mathrm{rc}}(D,T,X;p)(Y - m_{0,0}(X))\right]
$$
...
<img src="30.2-did-other_files/figure-html/unnamed-chunk-29-1.png" width="90%" style="display: block; margin: auto;" />
...
<img src="30.2-did-other_files/figure-html/unnamed-chunk-29-2.png" width="90%" style="display: block; margin: auto;" />
