...
| [Derivative-Free](#sec-derivative-free)                                | [Secant Method](#secant-method)                                                    | Approximates derivative from function evaluations  | No              | Local            | Medium         |
...
<img src="06-nonlinear-regession_files/figure-html/fig-gauss-newton-levenberg-marquardt-1.png" alt="Scatter plot with a fitted curve titled 'Data and Fitted Curve (Gauss–Newton/Levenberg–Marquardt).' The x-axis is labeled 'x' ranging from 0 to 10, and the y-axis is labeled 'y' ranging from 0 to 40. Black dots represent data points, and a red line represents the fitted curve. A legend indicates black dots as 'Data' and the red line as 'Fitted Curve.'" width="100%" />
<p class="caption">(\#fig:fig-gauss-newton-levenberg-marquardt)Data and Fitted Curve (Gauss–Newton/Levenberg–Marquardt)</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06-nonlinear-regession_files/figure-html/fig-modified-gauss-newton-1.png" alt="Scatter plot titled 'Modified Gauss–Newton' showing data points and a fitted curve. The x-axis ranges from 0 to 10, and the y-axis ranges from 0 to 40. Black dots represent data points, and a red line represents the fitted curve. A legend indicates 'Data' with a black dot and 'Fitted Curve' with a red line." width="100%" />
<p class="caption">(\#fig:fig-modified-gauss-newton)Modified Gauss–Newton</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06-nonlinear-regession_files/figure-html/fig-gradient-descent-convergence-1.png" alt="Chart titled 'Gradient Descent Convergence' showing the sum of squared errors (SSE) on the y-axis and iterations on the x-axis. The blue line starts at an SSE of 0.05 and quickly drops to 0, remaining constant across 500 iterations, indicating convergence." width="100%" />
<p class="caption">(\#fig:fig-gradient-descent-convergence)Gradient Descent Convergence</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06-nonlinear-regession_files/figure-html/fig-lv-convergence-1.png" alt="Chart titled 'Levenberg–Marquardt Convergence' showing the sum of squared errors (SSE) on the y-axis against iterations on the x-axis. The graph features a sharp peak at iteration 9, indicating a significant increase in SSE, followed by a return to baseline. The x-axis ranges from 0 to 12, and the y-axis ranges from 0 to 20000." width="100%" />
<p class="caption">(\#fig:fig-lv-convergence)Levenberg–Marquardt Convergence</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06-nonlinear-regession_files/figure-html/fig-nr-convergence-1.png" alt="Chart titled 'Newton–Raphson Convergence' showing the Sum of Squared Errors (SSE) on the y-axis and Iteration on the x-axis. The graph depicts a rapid decrease in SSE to near zero within the first few iterations, indicating quick convergence. The line is blue and flattens out after the initial drop." width="100%" />
<p class="caption">(\#fig:fig-nr-convergence)Newton–Raphson Convergence</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06-nonlinear-regession_files/figure-html/fig-trust-region-convergence-1.png" alt="Graph titled 'Trust-Region Reflective Convergence' showing the convergence of SSE (Sum of Squared Errors) over iterations. The X-axis represents iterations ranging from 0 to 500, and the Y-axis represents SSE values starting from 12,500 to 20,000. The curve shows a rapid decrease in SSE initially, stabilizing as iterations increase. The graph is depicted in blue." width="100%" />
<p class="caption">(\#fig:fig-trust-region-convergence)Trust-Region Reflective Convergence</p>
</div>
