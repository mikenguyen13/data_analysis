...
#> admisc               admisc C:/Program Files/R/R-4.2.3/library    0.32     <NA>
#> AER                     AER C:/Program Files/R/R-4.2.3/library  1.2-10     <NA>
#> agridat             agridat C:/Program Files/R/R-4.2.3/library    1.21     <NA>
#> AlignAssign     AlignAssign C:/Program Files/R/R-4.2.3/library   0.5.0     <NA>
#> alphavantager alphavantager C:/Program Files/R/R-4.2.3/library   0.1.3     <NA>
#>                                                                                              Depends
#> abind                                                                                   R (>= 1.5.0)
#> admisc                                                                                  R (>= 3.5.0)
...
#> agridat           <NA>  CC BY-SA 4.0            <NA>                  <NA>
#> AlignAssign       <NA>         GPL-2            <NA>                  <NA>
#> alphavantager     <NA>    GPL (>= 3)            <NA>                  <NA>
#>               OS_type MD5sum NeedsCompilation Built
#> abind            <NA>   <NA>               no 4.2.0
#> admisc           <NA>   <NA>              yes 4.2.3
#> AER              <NA>   <NA>               no 4.2.3
#> agridat          <NA>   <NA>               no 4.2.3
#> AlignAssign      <NA>   <NA>               no 4.2.3
#> alphavantager    <NA>   <NA>               no 4.2.3
