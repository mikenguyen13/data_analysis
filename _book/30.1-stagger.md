...
<img src="30.1-stagger_files/figure-html/fig-event-study-dynamic-effects-1.png" alt="A dot-and-whisker plot showing ATT estimates over event time. Points before treatment hover near zero, while post-treatment estimates increase steadily, with confidence intervals widening over time." width="90%" />
<p class="caption">(\#fig:fig-event-study-dynamic-effects)Event Study Dynamic Treatment Effects</p>
</div>
...
: (#tab:did-comparison-design-assumptions) Comparisons of Designs' Assumptions
...
<div class="figure" style="text-align: center">
<img src="30.1-stagger_files/figure-html/event-study-effect-on-y-1.png" alt="Dot plot of treatment effects over time with 95% confidence intervals. Pre-treatment estimates hover near zero, while post-treatment effects show a rising trend, indicating increasing impact." width="90%" />
<p class="caption">(\#fig:event-study-effect-on-y)Effect on y</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="30.1-stagger_files/figure-html/scatter-regression-x1-y-1.png" alt="A scatter plot showing a dense cloud of black points with a light blue regression line sloping upward, indicating a positive linear relationship between x1 and y, along with a shaded confidence band." width="90%" />
<p class="caption">(\#fig:scatter-regression-x1-y)Scatter Plot of Y against X1</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="30.1-stagger_files/figure-html/residualized-scatter-x1-y-1.png" alt="Scatter plot of residualized y against residualized x1, with a fitted linear regression line and shaded confidence band. The plot reveals a positive partial relationship between the variables." width="90%" />
<p class="caption">(\#fig:residualized-scatter-x1-y)Scatter Plot of Residualized Y against Residualized X1</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="30.1-stagger_files/figure-html/dynamic-treatment-comparison-att-1.png" alt="Line plot showing estimated ATT over event time for three estimators: cs (red), sa (green), and stacked (blue). All estimators show a dip around event time zero, followed by increasing effects. Confidence bands are shown as shaded regions." width="90%" />
<p class="caption">(\#fig:dynamic-treatment-comparison-att)Comparison of Dynamic Average Treatment Effects</p>
</div>
