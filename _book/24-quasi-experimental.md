...
## -3.7962 -0.6889  0.0168  0.6628  3.4514 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 17.04046    0.06511  261.70   <2e-16 ***
## D            9.92609    0.11971   82.92   <2e-16 ***
## x            1.98718    0.03256   61.03   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 1.013 on 997 degrees of freedom
## Multiple R-squared:  0.9578,	Adjusted R-squared:  0.9577 
## F-statistic: 1.132e+04 on 2 and 997 DF,  p-value: < 2.2e-16
```
...
![](24-quasi-experimental_files/figure-epub3/unnamed-chunk-35-1.png)<!-- -->
...
```
## Created main weights for synthetic control: Time = 0.97
```
...
## 
## Calculation of weights complete: Total time = 1.59
## 
## Calculating basic statistics for end.post = 16...
## Completed calculation of basic statistics for end.post = 16.  Time = 3.28
## 
...
## 
## microsynth complete: Overall time = 13.14
```
...
![](24-quasi-experimental_files/figure-epub3/unnamed-chunk-55-1.png)<!-- -->
