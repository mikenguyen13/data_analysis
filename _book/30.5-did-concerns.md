...
<img src="30.5-did-concerns_files/figure-html/causalverse-plot-par-trends-1.png" alt="Line plot showing parallel trends between California (treated) and control units over time quarters, displaying the Rate metric without confidence intervals" width="90%" />
<p class="caption">(\#fig:causalverse-plot-par-trends)Parallel Trends for Rate</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="30.5-did-concerns_files/figure-html/fig-parallel-trends-manual-1.png" alt="Line plot displaying average Rate values across quarters, with separate lines for California (treated) and control groups, using AMA theme styling" width="90%" />
<p class="caption">(\#fig:fig-parallel-trends-manual)Manual parallel trends plot showing average rates</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="30.5-did-concerns_files/figure-html/fig-prior-trend-coef-1.png" alt="Coefficient plot displaying point estimates and confidence intervals from the prior trend regression model, without grid lines" width="90%" />
<p class="caption">(\#fig:fig-prior-trend-coef)Coefficient plot for prior trend analysis</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="30.5-did-concerns_files/figure-html/fig-placebo-effects-1.png" alt="Point plot with error bars showing estimated placebo treatment effects and their confidence intervals for different models. A horizontal dashed red line at zero indicates no effect. Blue points and error bars represent the estimates and their uncertainty." width="90%" />
<p class="caption">(\#fig:fig-placebo-effects)Placebo treatment effects on organ donation rate</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="30.5-did-concerns_files/figure-html/fig-poisson-event-study-1.png" alt="Event study plot showing treatment effect coefficients over time from a Poisson regression model with period 5 as the reference. Points represent coefficient estimates with confidence intervals, allowing assessment of pre-treatment parallel trends and post-treatment effects." width="90%" />
<p class="caption">(\#fig:fig-poisson-event-study)Event study estimates from Poisson regression model</p>
</div>
...
<img src="30.5-did-concerns_files/figure-html/unnamed-chunk-6-1.png" width="90%" style="display: block; margin: auto;" />
...
-   Two bounding strategies in @rambachan2023more
    -   [Relative magnitude bounds](#sec-relative‑magnitude-restriction-honestdid): $|\delta| \leq M \cdot \max$ pre-period jumps
    -   [Smoothness bounds](#sec-smoothness-restriction-honestdid): allow $\delta$'s slope to shift by at most $M$ per period.
