...
-   [Instrumental Variables (Brief)] can help fix this problem

-   There can also be measurement error in dummy variables and you can still use [Instrumental Variables (Brief)] to fix it.
...
assume $Z_t$ (unobserved) to be uncorrelated with $\epsilon_t$, which is similar to [Instrumental Variables (Brief)]. Hence, $Z_t$ and $ν_t$ can't be identified without distributional assumptions
