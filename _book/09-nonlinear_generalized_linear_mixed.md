...
#> 1                   PQL (MASS)           50    4.36     1.00
#> 2 Numerical Integration (lme4)           50    8.98     2.06
```
...
#> herd   0.07063 9.692e-17   0.5178    24.21
#> 
#>  R-structure:  ~units
#> 
#>       post.mean l-95% CI u-95% CI eff.samp
#> units     1.019 0.001394    1.994    41.46
#> 
#>  Location effects: cbind(incidence, size - incidence) ~ period 
#> 
#>             post.mean l-95% CI u-95% CI eff.samp  pMCMC    
#> (Intercept)   -1.5184  -2.1070  -0.8563    866.8 <0.001 ***
#> period2       -1.2384  -2.1924  -0.2763    814.4  0.022 *  
#> period3       -1.3623  -2.4241  -0.3404    423.5  0.012 *  
#> period4       -2.0180  -3.3176  -0.9533    376.5 <0.001 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
#>             post.mean  l-95% CI   u-95% CI eff.samp pMCMC
#> (Intercept) -1.518387 -2.107027 -0.8563162 866.8111 0.001
#> period2     -1.238402 -2.192393 -0.2762579 814.3531 0.022
#> period3     -1.362322 -2.424085 -0.3403704 423.4672 0.012
#> period4     -2.018006 -3.317563 -0.9533247 376.4856 0.001
```
...
#> 
#>       post.mean  l-95% CI u-95% CI eff.samp
#> block   0.01214 5.472e-17  0.01668    791.1
#> 
#>  R-structure:  ~units
#> 
#>       post.mean l-95% CI u-95% CI eff.samp
#> units     1.067   0.3361    1.941    485.2
#> 
#>  Location effects: cbind(y, n - y) ~ gen 
#> 
#>             post.mean l-95% CI u-95% CI eff.samp  pMCMC    
#> (Intercept)   1.99591  0.65346  3.41779    826.3  0.010 *  
#> genG02       -0.41965 -2.28157  1.41017    908.7  0.666    
#> genG03       -0.76976 -2.86277  1.06801   1000.0  0.434    
#> genG04       -1.85788 -3.86373 -0.04027    848.0  0.060 .  
#> genG05       -0.39076 -2.40421  1.44283   1000.0  0.716    
#> genG06       -1.31857 -3.24040  0.48095    818.5  0.162    
#> genG07       -0.79303 -2.66806  1.10452   1000.0  0.388    
#> genG08       -2.12004 -3.93637 -0.31697    729.3  0.022 *  
#> genG09       -1.89865 -3.65747 -0.18248   1000.0  0.032 *  
#> genG10       -0.83074 -2.57605  1.23376    839.1  0.402    
#> genG11       -2.01243 -4.07204 -0.28634    586.4  0.034 *  
#> genG12       -1.96678 -3.77565 -0.14728   1000.0  0.040 *  
#> genG13       -4.48060 -6.64994 -2.26667    693.0 <0.001 ***
#> genG14       -3.26123 -5.25412 -1.47261    633.8 <0.001 ***
#> genG15       -2.83491 -4.85355 -0.95720    774.5  0.006 ** 
#> genG16       -3.93455 -6.07112 -1.94770    657.9 <0.001 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
