...
<img src="06.01-nonlinear-regression_files/figure-html/fig-secant-method-1.png" alt="Scatter plot titled 'Secant Method' showing data points and a fitted curve. The x-axis is labeled 'x' and the y-axis is labeled 'y.' Black dots represent data points, and a red line represents the fitted curve. A legend indicates 'Data' with a black dot and 'Fitted Curve' with a red line. The curve shows a sigmoidal trend, increasing from left to right." width="100%" />
<p class="caption">(\#fig:fig-secant-method)Secant Method</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06.01-nonlinear-regression_files/figure-html/fig-grid-search-1.png" alt="Scatter plot titled 'Grid Search: Nonlinear Regression Optimization' showing data points and a fitted curve. The x-axis is labeled 'x' and the y-axis is labeled 'y.' Black dots represent data points, and a red line represents the fitted curve. A legend indicates 'Data' with a black dot and 'Fitted Curve' with a red line. The curve demonstrates a nonlinear relationship between x and y." width="100%" />
<p class="caption">(\#fig:fig-grid-search)Grid Search: Nonlinear Regression Optimization</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06.01-nonlinear-regression_files/figure-html/fig-nelder-mead-1.png" alt="Scatter plot titled 'Nelder–Mead: Nonlinear Regression Optimization' showing data points and a fitted curve. The x-axis ranges from -5 to 5, and the y-axis ranges from 0 to 4. Black dots represent data points, and a red line represents the fitted curve. A legend indicates 'Data' for black dots and 'Fitted Curve' for the red line." width="100%" />
<p class="caption">(\#fig:fig-nelder-mead)Nelder–Mead: Nonlinear Regression Optimization</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06.01-nonlinear-regression_files/figure-html/fig-powerll-method-1.png" alt="Scatter plot titled 'Powell's Method: Nonlinear Regression Optimization' showing data points and a fitted curve. The x-axis is labeled 'x' and the y-axis is labeled 'y.' Black dots represent data points, and a red line represents the fitted curve. A legend indicates 'Data' and 'Fitted Curve.'" width="100%" />
<p class="caption">(\#fig:fig-powerll-method)Powell's Method: Nonlinear Regression Optimization</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06.01-nonlinear-regression_files/figure-html/fig-random-search-1.png" alt="Scatter plot titled 'Random Search: Nonlinear Regression Optimization' showing data points and a fitted curve. The x-axis is labeled 'x' and the y-axis is labeled 'y.' Black dots represent data points, and a red line represents the fitted curve. A legend indicates 'Data' with a black dot and 'Fitted Curve' with a red line." width="100%" />
<p class="caption">(\#fig:fig-random-search)Random Search: Nonlinear Regression Optimization</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06.01-nonlinear-regression_files/figure-html/fig-hooke-jeeves-1.png" alt="Scatter plot titled 'Hooke–Jeeves: Nonlinear Regression Optimization' showing data points and a fitted curve. The x-axis is labeled 'x' and the y-axis is labeled 'y.' The legend indicates black dots represent data and a red line represents the fitted curve. The curve demonstrates a nonlinear relationship, increasing from left to right." width="100%" />
<p class="caption">(\#fig:fig-hooke-jeeves)Hooke–Jeeves: Nonlinear Regression Optimization</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06.01-nonlinear-regression_files/figure-html/fig-optim-1.png" alt="Scatter plot titled 'Optim(): Nonlinear Regression Optimization' showing data points and a fitted curve. The x-axis is labeled 'x' and the y-axis is labeled 'y.' Black dots represent data points, and a red line represents the fitted curve. A legend indicates the symbols for 'Data' and 'Fitted Curve.' " width="100%" />
<p class="caption">(\#fig:fig-optim)Optim(): Nonlinear Regression Optimization</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06.01-nonlinear-regression_files/figure-html/fig-differential-evoluion-1.png" alt="Scatter plot titled 'Differential Evolution' showing data points and a fitted curve. The x-axis is labeled 'x' and the y-axis is labeled 'y.' Black dots represent data points, and a red line represents the fitted curve. A legend indicates black dots as 'Data' and the red line as 'Fitted Curve.' The curve shows a sigmoidal trend." width="100%" />
<p class="caption">(\#fig:fig-differential-evoluion)Differential Evolution</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06.01-nonlinear-regression_files/figure-html/fig-simulated-annealing-1.png" alt="Scatter plot titled 'Simulated Annealing: Nonlinear Regression Optimization' showing data points and a fitted curve. The x-axis is labeled 'x' and the y-axis is labeled 'y.' Black dots represent data points, and a red line represents the fitted curve, illustrating the optimization process. A legend indicates 'Data' and 'Fitted Curve.'" width="100%" />
<p class="caption">(\#fig:fig-simulated-annealing)Simulated Annealing: Nonlinear Regression Optimization</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06.01-nonlinear-regression_files/figure-html/fig-genetic-algo-1.png" alt="Scatter plot titled 'Genetic Algorithm: Nonlinear Regression Optimization' showing data points and a fitted curve. The x-axis is labeled 'x' and the y-axis is labeled 'y.' Black dots represent data points, and a red line represents the fitted curve, illustrating the optimization process. A legend indicates 'Data' and 'Fitted Curve.'" width="100%" />
<p class="caption">(\#fig:fig-genetic-algo)Genetic Algorithm: Nonlinear Regression Optimization</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06.01-nonlinear-regression_files/figure-html/fig-particle-swarm-opti-1.png" alt="Scatter plot titled 'Particle Swarm Optimization: Nonlinear Regression Optimization' showing data points and a fitted curve. The x-axis is labeled 'x' and the y-axis is labeled 'y.' Black dots represent data, and a red line represents the fitted curve. A legend indicates the symbols for data and the fitted curve." width="100%" />
<p class="caption">(\#fig:fig-particle-swarm-opti)Particle Swarm Optimization: Nonlinear Regression Optimization</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06.01-nonlinear-regression_files/figure-html/fig-evolutionary-strategies-1.png" alt="Scatter plot titled 'Evolutionary Strategies: Nonlinear Regression Optimization' showing data points and a fitted curve. The x-axis is labeled 'x' and the y-axis is labeled 'y.' Black dots represent data points, and a red line represents the fitted curve, illustrating the optimization process. A legend indicates 'Data' and 'Fitted Curve.'" width="100%" />
<p class="caption">(\#fig:fig-evolutionary-strategies)Evolutionary Strategies: Nonlinear Regression Optimization</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06.01-nonlinear-regression_files/figure-html/fig-log-linear-nonlinear-1.png" alt="Scatter plot titled 'Log–Linearization: Nonlinear Regression Optimization' showing data points and a fitted log-linear model. The x-axis is labeled 'x' ranging from 0 to 10, and the y-axis is labeled 'y' ranging from 0 to 40. Black dots represent data points, and a red line represents the fitted log-linear model. A legend indicates the symbols for data and the fitted model." width="100%" />
<p class="caption">(\#fig:fig-log-linear-nonlinear)Log–Linearization: Nonlinear Regression Optimization</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06.01-nonlinear-regression_files/figure-html/fig-adaptive-lm-nonlinear-1.png" alt="Scatter plot titled 'Adaptive Levenberg–Marquardt: Nonlinear Regression Optimization' showing data points and a fitted curve. The x-axis ranges from -4 to 4, and the y-axis ranges from 0 to 4. Black dots represent data points, and a red line represents the fitted curve. A legend indicates 'Data' and 'Fitted Curve.' " width="100%" />
<p class="caption">(\#fig:fig-adaptive-lm-nonlinear)Adaptive Levenberg–Marquardt: Nonlinear Regression Optimization</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06.01-nonlinear-regression_files/figure-html/fig-comparison-sse-by-method-1.png" alt="Bar chart comparing the Log(Sum of Squared Errors) for different methods and problem complexities. The x-axis lists various methods such as Differential Evolution, Genetic Algorithm, and Particle Swarm. The y-axis represents the Log(Sum of Squared Errors). Bars are color-coded: red for complex problems and blue for simple problems. The chart highlights significant differences in error values across methods, with the Steepest Descent method showing a notably high error for complex problems." width="100%" />
<p class="caption">(\#fig:fig-comparison-sse-by-method)Comparison of SSE by Method and Problem Complexity</p>
</div>
