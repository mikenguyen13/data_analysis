...
#> % Date and time: Mon, Jan 03, 2022 - 9:36:56 PM
...
#> 
#> % Table created by stargazer v.5.2.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
#> % Date and time: Mon, Jan 03, 2022 - 9:36:57 PM
...
<img src="28-report_files/figure-html/unnamed-chunk-9-1.png" width="90%" style="display: block; margin: auto;" />

```r
plot_summs(fit_c, robust = "HC3", coefs = coef_names, plot.distributions = TRUE)
```

<img src="28-report_files/figure-html/unnamed-chunk-9-2.png" width="90%" style="display: block; margin: auto;" />
