...
2.  A symbolic language built around the do-operator ($do(X)$), a mathematical notation for interventions.
...
1.  Encoding causal assumptions through causal graphs, for transparency and testability.
2.  Do-calculus for controlling confounding via the backdoor criterion.
3.  Algorithmization of counterfactuals for modeling "what if?" scenarios.
4.  Mediation analysis for understanding direct versus indirect effects.
5.  External validity and adaptability for addressing selection bias and domain adaptation.
6.  Handling missing data using causal methods to infer missing information.
7.  Causal discovery, which learns causal relationships from data using tools such as d-separation, functional decomposition [@hoyer2008nonlinear], and spontaneous local changes [@pearl2014graphical].
