...
Consider this paradox through a practical business example.
...
```{r, fig.cap='Simpson Paradox in Marketing', fig.alt='Bar chart comparing conversion rates for Campaigns A and B across High-Value and Low-Value customer segments.'}
library(ggplot2)
...
```{r, fig.cap='LATE Instrumental Variables', fig.alt='Flow chart showing relationships between treatment assignment instrument, unmeasured confounders, treatment status, and outcome with key IV assumptions marked.', echo = FALSE}
