...
In a standard DID setup, researchers often *use* the phrases "effect additivity" and "effect homogeneity" interchangeably, because the customary linear-in-levels model embeds *both* ideas. Strictly speaking, however, they are not identical:
