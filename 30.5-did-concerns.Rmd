...
```{r causalverse-plot-par-trends, fig.cap="Parallel Trends for Rate", fig.alt='Line plot showing parallel trends between California (treated) and control units over time quarters, displaying the Rate metric without confidence intervals'}
# use my package
...
```{r fig-prior-trend-coef, fig.cap='Coefficient plot for prior trend analysis', fig.alt='Coefficient plot displaying point estimates and confidence intervals from the prior trend regression model, without grid lines'}
...
```{r fig-poisson-event-study, fig.cap='Event study estimates from Poisson regression model', fig.alt='Event study plot showing treatment effect coefficients over time from a Poisson regression model with period 5 as the reference. Points represent coefficient estimates with confidence intervals, allowing assessment of pre-treatment parallel trends and post-treatment effects.'}
iplot(res_pois_es)
```
