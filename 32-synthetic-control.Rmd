...
Figure \@ref(fig:sc-gsynth-stateA) renders the GSC treatment-effect, counterfactual, and control-case panels for the simulated State A example.

```{r sc-gsynth-stateA, fig.cap="Generalized synthetic control output for the simulated State A example, showing estimated treatment effects, the counterfactual trajectory, and the raw control-unit trajectories."}
