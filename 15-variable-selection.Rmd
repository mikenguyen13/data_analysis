...
```{r fig-best-subset-r2, fig.cap="Best Subset Adjusted R2", fig.alt="Bar chart showing adjusted R-squared values for variable combinations. The y-axis is labeled adjr2 with values 0.37, 0.69, and 0.74. The x-axis includes Intercept, x1, x2, x3, and x4. Black and gray bars represent subset performance in a statistical model", out.width="100%", fig.align="center"}
...
```{r fig-rmse-cv-line-chart, fig.cap='RMSE CV', fig.alt='Line chart showing RMSE (Cross-Validation) on the y-axis against Variables on the x-axis. The RMSE decreases sharply from 2.35 to a minimum around 2.10 at 3 variables, then fluctuates slightly between 2.10 and 2.15 as the number of variables increases to 10.'}
# Plot performance
