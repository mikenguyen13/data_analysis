...
Table \@ref(tab:event-study-firm-initiated) collects representative marketing event studies on firm-initiated activities, organised by event type.
...
Event studies are also used to examine the impact of external events on firm value, including regulatory decisions, media coverage, economic shocks, and unexpected crises (Table \@ref(tab:event-study-non-firm)).
