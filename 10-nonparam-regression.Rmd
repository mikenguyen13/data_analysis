...
```{r Visualization of Smoothing Spline Fits}
...
```{r Final Smoothing Spline Fit with Optimal lambda}
...
```{r Visualizing Smooth Functions (Partial Dependence Plots)}
# Plot smooth terms
