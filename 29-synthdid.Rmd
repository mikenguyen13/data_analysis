...
Figure \@ref(fig:sdid-estimator-comparison-grid) shows how to fit and visualise a panel of estimators (SDID, DiD, SC, SC-ridge, difp, difp-ridge) side by side using `causalverse::synthdid_plot_ate` and `gridExtra::grid.arrange` (the chunk is not evaluated in the build).

```{r sdid-estimator-comparison-grid, eval=FALSE, fig.cap="Side-by-side ATE plots for SDID, DiD, SC, SC-ridge, difp, and difp-ridge estimators arranged in a 2-by-3 grid, illustrating how to benchmark SDID against alternative panel estimators on the same dataset."}
library(causalverse)
