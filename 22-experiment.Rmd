...
```{r, fig.cap='Distribution of Outcomes', fig.alt='Bar chart showing outcome frequencies with high frequency at 0 and decreasing frequencies for outcomes 1 through 6.'}
