...
You should see that the synthetic dataset's means, SDs, and correlation matrix are **very close** to the manually collected values from `df_original`. Figure \@ref(fig:repsynth-marginal-and-pairwise) shows per-variable histograms and the full pairwise scatter-and-correlation chart for the synthetic data.

```{r repsynth-marginal-and-pairwise, fig.cap="Marginal histograms (top) and pairwise scatter-correlation chart (bottom) for the four synthetic variables, used to inspect both univariate and joint distributional fidelity.", message=FALSE}
