...
Figure \@ref(fig:eda-shiny-skeleton) sketches a minimal Shiny dashboard skeleton that lets the user pick a city and renders the corresponding median-price trend line.

```{r eda-shiny-skeleton, eval = FALSE, fig.cap="Skeleton for a Shiny dashboard that filters Texas housing by city and plots the median-price trend interactively."}
