...
Figure \@ref(fig:mm-nearest-balance-diagnostics) shows the post-matching balance diagnostics for the nearest-neighbour 1:1 propensity-score match: a jitter plot of the propensity-score distribution and QQ plots for selected covariates.

```{r mm-nearest-balance-diagnostics, fig.cap="Post-matching balance diagnostics for the nearest-neighbour 1:1 propensity-score match: a jitter plot of the propensity-score distribution and QQ plots for selected covariates."}
