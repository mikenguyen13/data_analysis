...
$A5: {y_i,x_{i1},...,x_{ik-1}: i = 1,..., n}$ is a random sample
 ...
 * with [A3][A3 Exogeneity of Independent Variables] and [A4][A4 Homoskedasticity], we have
    ...
    + **Non-autocorrelation**: $E(\epsilon_i\epsilon_j|x_1,...,x_n)=0$ The error term is uncorrelated across the draws conditional on the independent variables
...
From A1-A3, we have **identification** of the population parameter $\beta$
