...
```{r rd-simple-dynamic-slop, fig.cap='Regression Discontinuity Design: Dynamic Slope', fig.alt='Line graph illustrating a sharp regression discontinuity', include = FALSE}
