...
```{r rd-simple-constant-slope, fig.cap='Regression Discontinuity Design Constant Slope', fig.alt='Line graph illustrating a sharp regression discontinuity', echo=FALSE}
...
```{r rd-simple-dynamic-slope, fig.cap='Regression Discontinuity Design Dynamic Slope', fig.alt='Line graph illustrating a sharp regression discontinuity', echo=FALSE}
