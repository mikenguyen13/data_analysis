...
Transformations involve modifying one or both variables to address issues such as non-linearity, non-constant variance, or non-normality. The properties of least-squares estimates, however, apply to the **transformed model**, not the original variables.
