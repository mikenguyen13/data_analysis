...
Table \@ref(tab:endog-heckman-mroz-comparison) compares the OLS, Heckman two-step, maximum-likelihood, and manually-implemented Heckman estimates of the married-women's wage equation on the Mroz data, with robust standard errors reported for the OLS column.

```{r endog-heckman-mroz-comparison, fig.cap="Married women's wage regressions estimated four ways on the Mroz data: OLS with robust standard errors, Heckman two-step, Heckman maximum-likelihood, and a manually-implemented Heckman correction."}
library(stargazer)
library(plm)
library(sandwich)
