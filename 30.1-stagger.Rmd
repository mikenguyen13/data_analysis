...
```{r scatter-regression-x1-y, fig.cap='Scatter Plot of Y agaisnt X1', fig.alt='A scatter plot showing a dense cloud of black points with a light blue regression line sloping upward, indicating a positive linear relationship between x1 and y, along with a shaded confidence band.'}
# Simple FWL plot
