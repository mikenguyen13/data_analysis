...
```{r fig-flow-chart-prediction-and-causation, fig.cap='Flow Chart', fig.alt='Flow chart with nodes X0, X, Y, and II. Arrows indicate: X0 to Y (Causation), X0 to II (Prediction), X to Y, and Y to II. Shows directional relationships and predictive paths.'}
dag_plot
```
