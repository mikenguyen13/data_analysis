...
## Operation
R commands to do derivatives of a defined function
Taking derivatives in R involves using the ``expression,`` ``D,`` and ``eval`` functions.  You wrap the function you want to take the derivative of in expression(), then use D, then eval as follows.
